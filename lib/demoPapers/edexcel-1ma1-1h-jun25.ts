...
export const EDEXCEL_1MA1_1H_JUN25: PaperConfig = {
  ...
  questions: [
    ...
    { id: '7a',    label: '7(a)',    marks: 1,  topic: 'algebra',  skill: 'Algebraic Fractions',                                        skillIds: ['algebraic_fractions'], kind: 'mastery', visual: false, desc: 'cancel a repeated bracket factor from an algebraic fraction' },
