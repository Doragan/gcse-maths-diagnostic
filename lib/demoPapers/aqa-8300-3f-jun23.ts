...
export const AQA_8300_3F_JUN23: PaperConfig = {
  ...
  questions: [
    ...
    { id: '19',  label: '19',    marks: 2,  topic: 'shape',    skill: 'Area and Volume Scale Factors + Areas of Squares and Rectangles + Properties of 3D Solids', skillIds: ['area_and_volume_scale_factors', 'areas_of_squares_and_rectangles', 'properties_of_3d_solids'], kind: 'mastery', visual: false, desc: 'tick + worded reason about joined faces; not markable' },
