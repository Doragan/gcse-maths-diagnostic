...
export const AQA_8300_2H_JUN23: PaperConfig = {
  ...
  questions: [
    ...
    { id: '8',   label: '8',     marks: 2,  topic: 'algebra',  skill: 'Simplifying Expressions + Solving Linear Equations',                               skillIds: ['simplifying_expressions', 'solving_linear_equations'], kind: 'mastery', visual: false, desc: 'two-blank answer; values must be evaluated, not left embedded' },
