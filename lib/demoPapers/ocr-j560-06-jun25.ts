...
export const OCR_J560_06_JUN25: PaperConfig = {
  ...
  questions: [
    ...
    { id: '23',  label: '23',    marks: 3,  topic: 'ratio',    skill: 'Growth and Decay',                                                     skillIds: ['growth_and_decay'], kind: 'exam', visual: false, desc: 'initial value and multiplier of an exponential model from two points on its curve' },
