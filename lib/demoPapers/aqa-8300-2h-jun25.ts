...
export const AQA_8300_2H_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    '22': { skill: 'Fractional and Negative Enlargements + Enlargements', question: 'Triangle A has vertices at (2, 2), (6, 2) and (2, 4). Triangle B has vertices at (1, 1), (3, 1) and (1, 2). Describe fully the single transformation that maps triangle A to triangle B.', answer: 'An enlargement with scale factor <frac>1/2</frac>, centre the origin (0, 0)', working: 'Every coordinate is halved, which places the centre at the origin.' },
    '23': { skill: 'Vector Proof + Vectors + Ratio', question: 'OABC is a parallelogram, with the vector OA = a and the vector OC = c. M is the point on AB such that AM : MB = 1 : 3. Write down, in terms of a and c, the vector OM. You must show your working.', answer: 'OM = a + <frac>1/4</frac>c', working: 'AB is equal to OC, so AM is one quarter of c.' },
