...
export const AQA_8300_2H_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    '17': { skill: 'Combined Events + Ratio', question: 'When a biased spinner is spun, P(red) : P(blue) = 3 : 1. In a game the spinner is spun four times. The first way to win is to spin four reds. The second way is to spin red, blue, red, blue. How many times more likely is a player to win the first way than the second way?', answer: '9 times', working: 'The first way trades two blues for two reds, so the ratio is (3 ÷ 1)² = 9.' },
    '18': { skill: 'Cosine Rule + Angles on lines and Circles', question: 'In triangle ABC, AB = 8 cm, BC = 11 cm and angle ABC = 105°. Work out the length of AC, to 1 decimal place.', answer: '15.2 cm', working: 'AC² = 64 + 121 − 2 × 8 × 11 × cos 105° = 230.55' },
    ...
    '21b': { skill: 'Perpendicular Gradients', question: 'A circle has its centre at the origin and passes through the point P(3, −4).\nWork out the equation of the tangent to the circle at P. Give your answer in the form y = mx + c.', answer: 'y = 0.75x − 6.25', working: 'The radius OP has gradient −4/3, so the tangent has gradient 3/4 and passes through (3, −4).' },
    '22': { skill: 'Fractional and Negative Enlargements + Enlargements', question: 'Triangle A has vertices at (2, 2), (6, 2) and (2, 4). Triangle B has vertices at (1, 1), (3, 1) and (1, 2). Describe fully the single transformation that maps triangle A to triangle B.', answer: 'An enlargement with scale factor 1/2, centre the origin (0, 0)', working: 'Every coordinate is halved, which places the centre at the origin.' },
    '23': { skill: 'Vector Proof + Vectors + Ratio', question: 'OABC is a parallelogram, with the vector OA = a and the vector OC = c. M is the point on AB such that AM : MB = 1 : 3. Write down, in terms of a and c, the vector OM. You must show your working.', answer: 'OM = a + (1/4)c', working: 'AB is equal to OC, so AM is one quarter of c.' },
    '24': { skill: 'Proportion with Powers', question: 'A study suggests a student\'s exam mark m is directly proportional to the square root of their total revision time t. A student triples their total revision time. Work out the percentage increase in their exam mark, to 1 decimal place.', answer: '73.2%', working: 'The mark is multiplied by √3 = 1.732.' },
    '25': { skill: 'Composite Functions + Inverse Functions + Algebraic Proof', question: 'f(x) = 2x + 5 and g(x) = (x − 5)/2. Prove that fg(x) + gf(x) is always equal to 2x.', answer: 'Both compositions simplify to x, so the sum is 2x', working: 'f and g are inverses of each other, so each composition returns x.' },
  },
  challengeQuestions: [],
  sampleStudents: [],
  sampleMarks: {},
