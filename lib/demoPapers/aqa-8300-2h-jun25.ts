...
export const AQA_8300_2H_JUN25: PaperConfig = {
  ...
  questions: [
    ...
    { id: '14',  label: '14',    marks: 3,  topic: 'algebra',  skill: 'Expanding Brackets + Simplifying Expressions',                                                      skillIds: ['expanding_brackets', 'simplifying_expressions'], kind: 'mastery', visual: false, desc: 'open answer: any triple satisfying the identity is valid, so exact-match fails' },
