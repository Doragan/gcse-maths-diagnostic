...
export const EDEXCEL_1MA1_1F_JUN25: PaperConfig = {
  ...
  questions: [
    ...
    { id: '20a', label: '20(a)', marks: 3,  topic: 'probdata', skill: 'Probability Spaces + Calculating Simple Probability',              skillIds: ['probability_spaces', 'calculating_simple_probability'], kind: 'exam', visual: false, desc: 'missing probability from a table, given a ratio between two outcomes' },
    ...
    { id: '21a', label: '21(a)', marks: 2,  topic: 'algebra',  skill: 'Substitution + Quadratic Functions',                               skillIds: ['substitution', 'quadratic_functions'], kind: 'mastery', visual: false, desc: 'complete a table of values for a quadratic' },
