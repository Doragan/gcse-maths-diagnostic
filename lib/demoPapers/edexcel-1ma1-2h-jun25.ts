...
export const EDEXCEL_1MA1_2H_JUN25: PaperConfig = {
  ...
  questions: [
    ...
    { id: '16a', label: '16(a)', marks: 4,  topic: 'shape',    skill: 'Congruence and Similarity',                                        skillIds: ['congruence_and_similarity'], kind: 'exam', visual: false, desc: 'length in a pair of similar solids from their volumes' },
    { id: '16b', label: '16(b)', marks: 1,  topic: 'shape',    skill: 'Congruence and Similarity',                                        skillIds: ['congruence_and_similarity'], kind: 'mastery', visual: false, desc: 'exact surface-area multiplier between two similar solids' },
    { id: '17',  label: '17',    marks: 2,  topic: 'number',   skill: 'Fractional and Negative Indices',                                  skillIds: ['fractional_and_negative_indices'], kind: 'mastery', visual: false, desc: 'constant of an exponential curve from a point with a negative x-coordinate' },
