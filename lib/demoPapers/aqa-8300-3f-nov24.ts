...
export const AQA_8300_3F_NOV24: PaperConfig = {
  ...
  retrySet: {
    ...
    '21':  { skill: 'Ratio + Areas of Squares and Rectangles', question: 'Rectangle A is 12 cm by 3 cm. Rectangle B has the same area and is 6 cm wide. Work out the ratio perimeter A : perimeter B.' },
