...
export const AQA_8300_3F_NOV24: PaperConfig = {
  ...
  retrySet: {
    ...
    '14a': {
      skill: 'Venn Diagrams',
      question: '30 people were asked whether they like tea and whether they like coffee.\n18 like tea, 14 like coffee and 5 like neither.\nHow many like both?',
      answer: '7',
      working: '30 − 5 = 25 like at least one, and 18 + 14 = 32, so 32 − 25 = 7 like both.',
      diagram: {
        ...
        labels: [
          { x: 2.5, y: 6.2, text: 'Tea' },
          { x: 7.5, y: 6.2, text: 'Coffee' },
        ],
    ...
    '15':  { skill: 'Fractions of Amounts + Ratio', question: '180 people travel to work by bus, train or bike. <frac>2/9</frac> go by bus.\nThe rest split train : bike = 2 : 3.\nHow many go by bike?' },
    '16':  { skill: 'Percentage Decrease', question: 'A laptop is worth £750.\nIts value falls by 20% in the first year, then by 5% in the second year.\nWork out its value after two years.' },
    ...
    '21': {
      ...
      question: 'The diagram shows rectangles A and B.\nRectangle B has the same area as rectangle A.\nWork out the ratio perimeter of A : perimeter of B.\nGive your answer in its simplest form.\nNot drawn accurately.',
      answer: '5 : 4',
      working: 'B is 36 ÷ 6 = 6 cm tall, so the perimeters are 30 cm and 24 cm.',
      diagram: {
        mode: 'polygon', showAxes: false, showGrid: false,
    ...
    '22':  { skill: 'Bounds',              question: 'To the nearest pound, Tom has £20.\nHe wants to buy 7 tickets costing £2.75 each.\nShow that Tom definitely has enough money.' },
    ...
    '24a': { skill: 'Ratio',               question: 'A school has 720 students and the ratio of students to teachers is 20 : 1.\nThe number of students stays the same and the number of teachers increases by 4.\nWork out the new ratio of students to teachers, in the form n : 1' },
    '24b': { skill: 'Ratio Reasoning',     question: 'One coach is needed for every 50 passengers or fewer.\n340 passengers are travelling.\nJo works out 340 ÷ 50 = 6.8 and says 6 coaches are needed.\nWhat is wrong with her answer?' },
    ...
    '26':  { skill: 'Volume of a Sphere',  question: 'Volume of a sphere = <frac>4/3</frac> πr³.\nA hemisphere has radius 6 cm.\nKai writes: Volume = <frac>4/3</frac> × π × 6 × 3 × 2.\nWrite down two mistakes Kai has made.' },
  },
