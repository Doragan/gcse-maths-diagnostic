...
export const AQA_8300_1F_NOV23: PaperConfig = {
  ...
  questions: [
    ...
    { id: '13',  label: '13',    marks: 1,  topic: 'shape',    skill: 'Angles in Polygons',                                                  skillIds: ['angles_in_polygons'], kind: 'mastery', visual: false, desc: 'open answer: more than one shape name is valid' },
