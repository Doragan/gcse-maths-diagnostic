...
export const AQA_8300_2H_NOV23: PaperConfig = {
  ...
  questions: [
    ...
    { id: '25',  label: '25',    marks: 4,  topic: 'shape',    skill: 'Congruence and Similarity + Volume of a prism',                           skillIds: ['congruence_and_similarity', 'volume_of_a_prism'], kind: 'exam', visual: false, desc: 'static diagram supported' },
