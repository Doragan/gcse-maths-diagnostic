...
export const AQA_8300_2F_NOV24: PaperConfig = {
  ...
  questions: [
    { id: '1a', label: '1(a)', marks: 1, topic: 'algebra', skill: 'Sequences', desc: 'Next term: 4, 7, 10, 13, …', visual: false },
    { id: '1b', label: '1(b)', marks: 1, topic: 'algebra', skill: 'Sequences', desc: 'Next term: 19, 14, 9, 4, …', visual: false },
    { id: '1c', label: '1(c)', marks: 1, topic: 'algebra', skill: 'Sequences', desc: 'Term-to-term rule: 3, 6, 12, 24, …', visual: false },
    { id: '2a', label: '2(a)', marks: 1, topic: 'number', skill: 'Simple Arithmetic', desc: 'Cost of three candles at £4.55 each', visual: false },
    { id: '2b', label: '2(b)', marks: 2, topic: 'number', skill: 'Simple Arithmetic', desc: '£7.50 — enough for soap (£2.00) + body cream (£3.80) + lip scrub (£1.75)?', visual: false },
    { id: '3a', label: '3(a)', marks: 1, topic: 'algebra', skill: 'Solving Linear Equations', desc: 'Solve 5x = 30', visual: false },
    { id: '3b', label: '3(b)', marks: 1, topic: 'algebra', skill: 'Solving Linear Equations', desc: 'Solve −2 + y = 10', visual: false },
    { id: '3c', label: '3(c)', marks: 2, topic: 'number', skill: 'Simplifying Indices', desc: 'Simplify fully 20w ÷ 4w', visual: false },
    { id: '4a', label: '4(a)', marks: 1, topic: 'shape', skill: 'Coordinates', desc: 'Coordinates of point C (from the grid)', visual: false },
    { id: '4b', label: '4(b)', marks: 1, topic: 'shape', skill: 'Coordinates', desc: 'Midpoint of A and C (from the grid)', visual: false },
    { id: '4c', label: '4(c)', marks: 1, topic: 'shape', skill: 'Coordinates', desc: 'Plot D on the grid so ABCD is a rhombus', visual: true },
    { id: '5a', label: '5(a)', marks: 1, topic: 'probdata', skill: 'Range', desc: 'Range of 14.2, 15.1, 16.5, 16.7, 18.0', visual: false },
    { id: '5b', label: '5(b)', marks: 2, topic: 'probdata', skill: 'Mean', desc: 'Mean of 14.2, 15.1, 16.5, 16.7, 18.0', visual: false },
    { id: '6a', label: '6(a)', marks: 1, topic: 'shape', skill: 'Angles on Lines and Circles', desc: 'Angle x on a straight line (diagram)', visual: false },
    { id: '6b', label: '6(b)', marks: 2, topic: 'shape', skill: 'Angles on Lines and Circles', desc: 'Angle y at an intersection (diagram)', visual: false },
    { id: '6c', label: '6(c)', marks: 3, topic: 'shape', skill: 'Angles on Lines and Circles', desc: 'Three lines intersect, angles 47° and 86° marked — classify the triangle formed', visual: false },
    { id: '7', label: '7', marks: 3, topic: 'ratio', skill: 'Proportion + Simple Arithmetic', desc: '5 packs of 8 cartons + 16 packs of 3 cartons; 4 cartons/day — how many days', visual: false },
    { id: '8', label: '8', marks: 3, topic: 'probdata', skill: 'Simple Charts', desc: 'Complete a pictogram (100 voters, Jo/Kim/Liam)', visual: true },
    { id: '9', label: '9', marks: 2, topic: 'probdata', skill: 'Systematic Listing', desc: 'List all 3-topping pizza combinations from 4 choices', visual: false },
    { id: '10a', label: '10(a)', marks: 1, topic: 'number', skill: 'Fractions, Decimals and Percentages', desc: '3/8 as a percentage', visual: false },
    { id: '10b', label: '10(b)', marks: 2, topic: 'number', skill: 'Converting Fractions to Decimals + Rounding', desc: '15/32 as a decimal, to 2dp', visual: false },
    { id: '11', label: '11', marks: 3, topic: 'number', skill: 'Simple Arithmetic', desc: 'True/May be true/Not true: three statements about number inequalities', visual: false },
    { id: '12a', label: '12(a)', marks: 2, topic: 'algebra', skill: 'Substitution', desc: 'Work out x² + 7x when x = −4', visual: false },
    ...
    { id: '17', label: '17', marks: 3, topic: 'ratio', skill: 'Proportion', desc: 'Map scale 1:4000, 7cm on the map — is the real distance more than 300m?', visual: false },
    { id: '18', label: '18', marks: 1, topic: 'ratio', skill: 'Inverse Proportion', desc: 'X inversely proportional to Y — circle the correct statement', visual: false },
    { id: '19', label: '19', marks: 2, topic: 'shape', skill: "Pythagoras' Theorem", desc: 'Right-angled triangle: hypotenuse 1.7, one leg 1.5 — show the other leg is 0.8', visual: false },
    { id: '20a', label: '20(a)', marks: 2, topic: 'probdata', skill: 'Simple Charts', desc: 'Beth: 125 spins, 0.32 rel. freq.; Lynn: 80 spins, 0.35 — how many more heads did Beth spin', visual: false },
    { id: '20b', label: '20(b)', marks: 1, topic: 'probdata', skill: 'Calculating Simple Probability + Relative Frequency', desc: "Lynn says her estimate (0.35) must be best since it's bigger than Beth's (0.32) — is she correct?", visual: false },
    { id: '21', label: '21', marks: 2, topic: 'number', skill: 'Decimals', desc: 'Oil: mass 537g, density 895,000 g/m³, 1m³=1000 litres — find the volume in litres', visual: false },
    { id: '22', label: '22', marks: 3, topic: 'shape', skill: 'Trigonometry (missing sides)', desc: 'Right-angled triangle: hypotenuse 21, angle 40° — find x (opposite side)', visual: false },
    { id: '23', label: '23', marks: 2, topic: 'number', skill: 'Upper and Lower Bounds', desc: 'Wall length 9m to the nearest metre — error interval', visual: false },
    { id: '24', label: '24', marks: 3, topic: 'ratio', skill: 'Reverse Percentage', desc: '384,000 cars sold this year is 20% more than last year — how many last year', visual: false },
    { id: '25', label: '25', marks: 3, topic: 'number', skill: 'Simplifying Indices', desc: 'Multiply pairs from xy, x², 5y² — three fully simplified products', visual: false },
    { id: '26', label: '26', marks: 5, topic: 'shape', skill: 'Solving Linear Equations + Areas of Squares and Rectangles', desc: 'Rectangle side labelled 4x+1 and 2x+17 (equal); AB:BC = 1:3 — find the area', visual: false },
  ],
