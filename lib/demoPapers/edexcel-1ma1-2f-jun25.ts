...
export const EDEXCEL_1MA1_2F_JUN25: PaperConfig = {
  ...
  questions: [
    ...
    { id: '7',   label: '7',     marks: 2,  topic: 'algebra',  skill: 'Solving Linear Equations',                                         skillIds: ['solving_linear_equations'], kind: 'mastery', visual: false, desc: 'find the input of a given cost rule from its output' },
