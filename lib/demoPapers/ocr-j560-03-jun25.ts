...
export const OCR_J560_03_JUN25: PaperConfig = {
  ...
  questions: [
    ...
    { id: '19',    label: '19',      marks: 4,  topic: 'shape',    skill: 'Area and Volume Scale Factors',                              skillIds: ['area_and_volume_scale_factors'], kind: 'exam', visual: false, desc: 'height of a similar cuboid from the two base areas' },
