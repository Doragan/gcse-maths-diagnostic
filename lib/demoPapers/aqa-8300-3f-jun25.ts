...
export const AQA_8300_3F_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    '3b': { skill: 'Calculating Simple Probability', question: 'Using the six possible drinks above, what fraction of them use chocolate?', answer: '1/3', working: '2 out of 6.' },
    ...
    '4b': { skill: 'Function Machines', question: 'The same machine multiplies the input by 3 and then subtracts 5. Work out the input when the output is 19', answer: '8', working: 'Work backwards: 19 + 5 = 24, then ÷ 3.' },
    ...
    '5a': { skill: 'Fractions Decimals and Percentages', question: 'Complete the table of equivalent fractions, decimals and percentages: (i) 1/4 = ? = ?%, (ii) ? = 0.2 = ?%, (iii) 3/5 = ? = ?%', answer: '(i) 0.25 and 25%, (ii) 1/5 and 20%, (iii) 0.6 and 60%' },
    ...
    '6': { skill: 'Converting Measurements', question: 'Which metric unit would be most suitable for each measurement? Choose millimetres, metres or kilometres for each. (i) The thickness of a coin. (ii) The width of a classroom. (iii) The distance between two cities.', answer: '(i) millimetres, (ii) metres, (iii) kilometres' },
    ...
    '7b': { skill: 'Percentage Change', question: 'Plan B has a free phone plus £38 per month for 24 months. During a sale, the total cost of Plan B is reduced by 15%. Which plan is cheaper for 24 months during the sale — Plan A at £732, or Plan B? Tick a box, and show working to support your answer.', answer: 'Plan A', working: 'Plan B is £912 before the sale and £775.20 after it.' },
    ...
    '9b': { skill: 'Indices', question: 'Which has the larger value, 0.6² or 0.6³? Tick a box, and give a reason for your answer.', answer: '0.6²', working: '0.36 against 0.216 — multiplying by a number below 1 makes it smaller each time.' },
    ...
    '14b': { skill: 'Expected Outcomes', question: 'There are 400 cards in the box described above. How many of the cards are not blue?', answer: '284', working: '1 − 0.29 = 0.71, and 400 × 0.71.' },
    '15': { skill: 'Congruence and Similarity', question: 'A and B are triangles. For each statement, tick the correct box — always congruent, sometimes congruent, or never congruent. (i) A\'s sides are the same lengths as B\'s sides. (ii) A\'s angles are the same as B\'s angles. (iii) A is an enlargement of B with scale factor 3.', answer: '(i) Always, (ii) Sometimes, (iii) Never', working: 'Equal angles fix the shape but not the size; an enlargement by 3 always changes the size.' },
    ...
    '17b': { skill: 'Relative Frequency', question: 'Which results would give the best estimate of the probability of heads? Tick one box: Ana\'s 50 throws / Ben\'s 150 throws / all 200 throws. Give a reason for your answer.', answer: 'All 200 throws', working: 'The more trials there are, the more reliable the estimate.' },
    ...
    '24b': { skill: 'Understanding Straight Line Graphs', question: 'A straight line has gradient 4 and passes through the point (2, 5). Circle the equation of the line: y = 2x + 1, y = 4x, y = 4x − 3, y = 4x + 5', answer: 'y = 4x − 3', working: '4 × 2 − 3 = 5, so the point fits.' },
  },
  challengeQuestions: [],
  sampleStudents: [],
  sampleMarks: {},
