  ...
  retrySet: {
    ...
    '4a': {
      ...
      diagram: {
        ...
        x: { min: 0, max: 12.4, step: 1, label: '' },
        y: { min: 0, max: 3, step: 1, label: '' },
        background: '<polyline points="0.3,1 2.5,1 2.5,2 0.3,2 0.3,1" stroke="#333" fill="none" /><polyline points="3.5,1 5.7,1 5.7,2 3.5,2 3.5,1" stroke="#333" fill="none" /><polyline points="6.7,1 8.9,1 8.9,2 6.7,2 6.7,1" stroke="#333" fill="none" /><polyline points="9.900000000000002,1 12.1,1 12.1,2 9.900000000000002,2 9.900000000000002,1" stroke="#333" fill="none" /><polyline points="2.5,1.5 3.44,1.5" stroke="#333" fill="none" /><polyline points="3.22,1.68 3.47,1.5 3.22,1.32" stroke="#333" fill="none" /><polyline points="5.7,1.5 6.64,1.5" stroke="#333" fill="none" /><polyline points="6.42,1.68 6.67,1.5 6.42,1.32" stroke="#333" fill="none" /><polyline points="8.9,1.5 9.84,1.5" stroke="#333" fill="none" /><polyline points="9.62,1.68 9.87,1.5 9.62,1.32" stroke="#333" fill="none" />',
        labels: [
          { x: 1.4, y: 1.5, text: 'Input' },
          { x: 4.6, y: 1.5, text: '× 3' },
          { x: 7.8, y: 1.5, text: '− 5' },
          { x: 11, y: 1.5, text: 'Output' },
        ],
        elements: [], tolerance: 0,
      },
    },
    ...
    '4c': {
      ...
      answer: '+ 9',
      working: 'x × 4 = 4x, and 4x + 9 needs 9 adding.',
      diagram: {
        mode: 'polygon', showAxes: false, showGrid: false,
        x: { min: 0, max: 12.4, step: 1, label: '' },
        y: { min: 0, max: 3, step: 1, label: '' },
