...
export const AQA_8300_3F_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    '5a': { skill: 'Fractions Decimals and Percentages', question: 'Complete the table of equivalent fractions, decimals and percentages.\n(i)   <frac>1/4</frac> = ?   = ?%\n(ii)  ?   = 0.2 = ?%\n(iii) <frac>3/5</frac> = ?   = ?%', answer: '(i) 0.25 and 25%, (ii) <frac>1/5</frac> and 20%, (iii) 0.6 and 60%' },
    '5b': { skill: 'Fractions Decimals and Percentages', question: 'A grid is made of 20 equal squares and 7 of them are shaded. What percentage of the grid is shaded?', answer: '35%', working: '<frac>7/20</frac> = <frac>35/100</frac>.' },
