  ...
  retrySet: {
    ...
    '1b': {
      ...
      diagram: {
        ...
        y: { min: -1, max: 3, step: 1, label: '' },
        background: '<rect x="0" y="0" width="1" height="1" stroke="#333" fill="none" /><rect x="1" y="0" width="1" height="1" stroke="#333" fill="none" /><rect x="0" y="1" width="1" height="1" stroke="#333" fill="none" /><rect x="4" y="0" width="1" height="1" stroke="#333" fill="none" /><rect x="5" y="0" width="1" height="1" stroke="#333" fill="none" /><rect x="6" y="0" width="1" height="1" stroke="#333" fill="none" /><rect x="4" y="1" width="1" height="1" stroke="#333" fill="none" /><rect x="5" y="1" width="1" height="1" stroke="#333" fill="none" /><rect x="9" y="0" width="1" height="1" stroke="#333" fill="none" /><rect x="10" y="0" width="1" height="1" stroke="#333" fill="none" /><rect x="11" y="0" width="1" height="1" stroke="#333" fill="none" /><rect x="12" y="0" width="1" height="1" stroke="#333" fill="none" /><rect x="9" y="1" width="1" height="1" stroke="#333" fill="none" /><rect x="10" y="1" width="1" height="1" stroke="#333" fill="none" /><rect x="11" y="1" width="1" height="1" stroke="#333" fill="none" />',
        labels: [
          { x: 1, y: -0.5, text: 'Pattern 1' },
          { x: 5.5, y: -0.5, text: 'Pattern 2' },
          { x: 10.5, y: -0.5, text: 'Pattern 3' },
        ],
        elements: [], tolerance: 0,
      },
    },
    ...
    '3a': { skill: 'Systematic Listing', question: 'Kai makes a drink using one type of milk and one flavour.\nThe milk is dairy (D) or oat (O). The flavour is vanilla (V), chocolate (C) or strawberry (S). List all 6 possible drinks. One has been done for you: DV.', answer: 'DV, DC, DS, OV, OC, OS', working: 'Take each milk in turn with every flavour.' },
    '3b': { skill: 'Calculating Simple Probability', question: 'Kai makes a drink using one type of milk and one flavour.\nThe milk is dairy or oat, and the flavour is vanilla, chocolate or strawberry. What fraction of the 6 possible drinks use chocolate?', answer: '<frac>1/3</frac>', working: '2 out of 6.' },
    ...
    '5b': {
      ...
      question: 'The grid is made of 20 equal squares.\nWhat percentage of the grid is shaded?',
      answer: '35%',
    ...
    '13': { skill: 'Areas of Squares and Rectangles + Areas of Triangles + Ratio', question: 'A rectangle measures 5 cm by 6 cm. A triangle has a base of 10 cm and a height of 4 cm. Work out the ratio area of rectangle : area of triangle. Give your answer in its simplest form.', answer: '3 : 2', working: 'Areas of 30 and 20, both divided by 10.' },
    ...
    '15': { skill: 'Congruence and Similarity', question: 'A and B are triangles. For each statement, state whether A and B are always congruent, sometimes congruent, or never congruent.\n(i)   A\'s sides are the same lengths as B\'s sides\n(ii)  A\'s angles are the same as B\'s angles\n(iii) A is an enlargement of B with scale factor 3', answer: '(i) Always, (ii) Sometimes, (iii) Never', working: 'Equal angles fix the shape but not the size; an enlargement by 3 always changes the size.' },
    '16': { skill: 'Forming Expressions and Formulae + Solving Linear Equations + Lengths and Perimeters', question: 'An equilateral triangle has sides of length (3x + 4) cm, (5x − 2) cm and (2x + 7) cm. Work out the perimeter of the triangle.', answer: '39 cm', working: '3x + 4 = 5x − 2 gives x = 3, so each side is 13 cm.' },
    ...
    '17b': { skill: 'Relative Frequency', question: 'Ana threw a biased coin 50 times, Ben threw the same coin 150 times. Which results would give the best estimate of the probability of heads? Give a reason for your answer.\nTick one box.\n[   ] Ana\'s 50 throws\n[   ] Ben\'s 150 throws\n[   ] All 200 throws', answer: 'All 200 throws', working: 'The more trials there are, the more reliable the estimate.' },
    '18': {
