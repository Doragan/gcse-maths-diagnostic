...
export const AQA_8300_3F_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    '3b': { skill: 'Calculating Simple Probability', question: 'Kai makes a drink using one type of milk and one flavour.\nThe milk is dairy or oat, and the flavour is vanilla, chocolate or strawberry. What fraction of the 6 possible drinks use chocolate?', answer: '1/3', working: '2 out of 6.' },
    ...
    '21': { skill: 'Ratio + Fractions of Amounts', question: 'Dan has £180. Dan\'s amount is 3/4 of Eve\'s amount, and Finn\'s amount : Eve\'s amount = 2 : 5. Work out how much money Finn has.', answer: '£96', working: 'Eve has £240, and Finn has two fifths of that.' },
