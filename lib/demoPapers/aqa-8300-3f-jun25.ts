...
export const AQA_8300_3F_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    '19a': {
      skill: 'Proportion',
      question: 'The diagram shows the positions of A, B and C on a scale drawing.\nThe scale is 1 : 250 000.\nWork out the actual distance from B to C, in kilometres.',
      answer: '15 km',
      working: 'B to C measures 6 cm, so 6 × 250 000 = 1 500 000 cm, and there are 100 000 cm in a kilometre.',
      diagram: {
        mode: 'polygon', showAxes: false,
        x: { min: 0, max: 10, step: 1, label: '' },
        y: { min: 0, max: 8, step: 1, label: '' },
        background: '<polyline points="8,7 8,1 2,1" stroke="#333" fill="none" /><circle cx="8" cy="7" r="0.13" fill="#333" /><circle cx="8" cy="1" r="0.13" fill="#333" /><circle cx="2" cy="1" r="0.13" fill="#333" /><polyline points="0.6,5.6 0.6,7.4" stroke="#333" fill="none" /><polyline points="0.35,7.05 0.6,7.4 0.85,7.05" stroke="#333" fill="none" />',
        labels: [
          { x: 8, y: 7, text: 'A', dx: 11, dy: -3 },
          { x: 8, y: 1, text: 'B', dx: 11, dy: 11 },
          { x: 2, y: 1, text: 'C', dx: -11, dy: 11 },
          { x: 0.6, y: 7.4, text: 'N', dy: -8 },
        ],
        elements: [], tolerance: 0,
      },
    },
