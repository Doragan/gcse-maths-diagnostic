...
export const AQA_8300_1H_NOV23: PaperConfig = {
  ...
  questions: [
    ...
    { id: '13',  label: '13',    marks: 3,  topic: 'algebra',  skill: 'Equations and Identities',                                                            skillIds: ['equations_and_identities'], kind: 'mastery', visual: false, desc: 'two-blank answer; values must be evaluated' },
