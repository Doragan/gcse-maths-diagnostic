...
export const OCR_J560_01_JUN25: PaperConfig = {
  ...
  questions: [
    ...
    { id: '23a',  label: '23(a)',  marks: 1,  topic: 'algebra',  skill: 'Equations and Identities',                             skillIds: ['equations_and_identities'], kind: 'mastery', visual: false, desc: 'decide whether each algebraic statement is an equation or an identity' },
