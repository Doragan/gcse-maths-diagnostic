...
export const AQA_8300_1F_NOV24: PaperConfig = {
  ...
  retrySet: {
    ...
    '7b': { skill: 'Frequency Trees + Calculating Simple Probability', question: '50 students were asked if they walk or cycle to school. 30 walk; the rest cycle. Of the walkers, 18 are in Year 7. What fraction of the walkers are in Year 7?' },
