...
export const AQA_8300_1F_NOV24: PaperConfig = {
  ...
  questions: [
    { id: '1a', label: '1(a)', marks: 1, topic: 'number', skill: 'Indices', desc: 'Square root of 49', visual: false },
    { id: '1b', label: '1(b)', marks: 1, topic: 'number', skill: 'Indices', desc: '3 cubed', visual: false },
    { id: '1c', label: '1(c)', marks: 1, topic: 'number', skill: 'Indices', desc: '10,000 as a power of 10', visual: false },
    { id: '2', label: '2', marks: 2, topic: 'number', skill: 'Converting Measurements + Proportion', desc: 'Ounces in 3 pounds (16 oz = 1 lb)', visual: false },
    { id: '3a', label: '3(a)', marks: 1, topic: 'number', skill: 'Irregular and Improper Fractions', desc: '3/2 as a mixed number', visual: false },
    { id: '3b', label: '3(b)', marks: 1, topic: 'number', skill: 'Adding and Subtracting Fractions', desc: '1/5 + 1/5', visual: false },
    { id: '4a', label: '4(a)', marks: 2, topic: 'number', skill: 'Factors and Multiples', desc: 'All factors of 20', visual: false },
    { id: '4b', label: '4(b)', marks: 1, topic: 'number', skill: 'Factors and Multiples', desc: 'Counterexample: sum of two multiples of 5 is always a multiple of 10?', visual: false },
    { id: '5', label: '5', marks: 2, topic: 'number', skill: 'Fractions, Decimals and Percentages', desc: 'Order 80%, 0.7, 3/4 by size', visual: false },
    { id: '6', label: '6', marks: 4, topic: 'number', skill: 'Simple Arithmetic', desc: '2 hats (£4.50 each) + 3 scarves = £28.50; cost per scarf', visual: false },
    { id: '7a', label: '7(a)', marks: 4, topic: 'probdata', skill: 'Frequency Trees', desc: 'Complete the frequency tree (120 people: 80 children, 40 adults)', visual: true },
    { id: '7b', label: '7(b)', marks: 2, topic: 'probdata', skill: 'Frequency Trees + Calculating Simple Probability', desc: 'Fraction of children who turned left', visual: false },
    { id: '8', label: '8', marks: 3, topic: 'probdata', skill: 'Simple Charts', desc: "Spot 3 mistakes in Ed's bar chart", visual: true },
    { id: '9a', label: '9(a)', marks: 4, topic: 'number', skill: 'Simple Arithmetic', desc: 'Complete a multiplication grid (odd numbers × primes)', visual: true },
    { id: '9b', label: '9(b)', marks: 2, topic: 'probdata', skill: 'Calculating Simple Probability', desc: 'P(product from the grid is a square number)', visual: false },
    { id: '10a', label: '10(a)', marks: 2, topic: 'algebra', skill: 'Simplifying Expressions', desc: 'Simplify 8m + 4 − 2m + 7', visual: false },
    { id: '10b', label: '10(b)', marks: 2, topic: 'algebra', skill: 'Simplifying Expressions', desc: 'Simplify ½c × 6d', visual: false },
    { id: '11', label: '11', marks: 4, topic: 'number', skill: 'Percentage Change + Simple Arithmetic', desc: '6 single bags at £55 each; multipack is 10% less', visual: false },
    { id: '12', label: '12', marks: 1, topic: 'ratio', skill: 'Ratio', desc: 'Write 6:2 in the form n:1', visual: false },
    { id: '13', label: '13', marks: 2, topic: 'number', skill: 'Simple Arithmetic', desc: 'x+y always/sometimes/never positive; x−y always/sometimes/never negative', visual: false },
    { id: '14a', label: '14(a)', marks: 1, topic: 'shape', skill: 'Congruence and Similarity', desc: 'Draw a shape congruent to triangle A', visual: true },
    { id: '14b', label: '14(b)', marks: 2, topic: 'shape', skill: 'Enlargements', desc: 'Enlarge shape B by scale factor 1/3', visual: true },
    { id: '15', label: '15', marks: 3, topic: 'ratio', skill: 'Ratio', desc: '35 books, adults:children = 6:1 — how many more adult books', visual: false },
    { id: '16', label: '16', marks: 2, topic: 'shape', skill: 'Constructions', desc: 'Accurately draw a semicircle-and-square compound shape', visual: true },
    { id: '17', label: '17', marks: 3, topic: 'ratio', skill: 'Compound Units', desc: '4 miles in 5 minutes — average speed in mph', visual: false },
    { id: '18', label: '18', marks: 3, topic: 'shape', skill: 'Coordinates + Straight Line Graphs', desc: 'J(0,12), K(5,10) on line JKLM with JK=KL=LM — find M', visual: false },
    { id: '19', label: '19', marks: 2, topic: 'number', skill: 'Indices', desc: '1.5 squared', visual: false },
    { id: '20a', label: '20(a)', marks: 1, topic: 'algebra', skill: 'Function Machines', desc: 'Complete a function machine so y = 4x + 5', visual: false },
    { id: '20b', label: '20(b)', marks: 1, topic: 'algebra', skill: 'Function Machines', desc: 'Complete a function machine so y = 3x − 24', visual: false },
    { id: '20c', label: '20(c)', marks: 1, topic: 'algebra', skill: 'Function Machines', desc: 'Complete a function machine so y = x', visual: false },
    { id: '21', label: '21', marks: 3, topic: 'number', skill: 'Simple Arithmetic', desc: 'Add 10 to every value in a list: True/False for mode, median, range', visual: false },
    { id: '22a', label: '22(a)', marks: 1, topic: 'algebra', skill: 'Sequences', desc: 'Missing term: 1, 4, 16, ?, 256', visual: false },
    { id: '22b', label: '22(b)', marks: 2, topic: 'algebra', skill: 'Sequences', desc: 'Fibonacci-type sequence 5, −9, … — next two terms', visual: false },
    { id: '23a', label: '23(a)', marks: 1, topic: 'shape', skill: 'Properties of 3D Solids', desc: 'Faces of a hexagonal prism (from the diagram)', visual: false },
    { id: '23b', label: '23(b)', marks: 2, topic: 'shape', skill: 'Areas of Compound Shapes', desc: 'Cross-section area from volume 3500 cm³, length 20 cm', visual: false },
    { id: '24', label: '24', marks: 2, topic: 'number', skill: 'Adding and Subtracting Fractions', desc: '1⅕ − 3/10, as a fraction', visual: false },
    { id: '25', label: '25', marks: 1, topic: 'shape', skill: 'Exact Trigonometric Values', desc: 'sin 90°', visual: false },
    { id: '26', label: '26', marks: 4, topic: 'shape', skill: 'Area of a Circle', desc: 'Large circle r=12cm, radii ratio 4:1 — shaded area in terms of π', visual: false },
    { id: '27a', label: '27(a)', marks: 2, topic: 'ratio', skill: 'Inverse Proportion', desc: '10 people take 9 hours — time for 15 people at the same rate', visual: false },
    { id: '27b', label: '27(b)', marks: 1, topic: 'ratio', skill: 'Inverse Proportion', desc: '6 of the 15 work slower, 9 faster — greater/same/less/impossible to say', visual: false },
  ],
