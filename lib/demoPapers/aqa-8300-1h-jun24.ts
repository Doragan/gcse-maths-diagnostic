...
export const AQA_8300_1H_JUN24: PaperConfig = {
  ...
  questions: [
    ...
    { id: '20',  label: '20',    marks: 3,  topic: 'algebra',  skill: 'Simplifying Expressions',                                                      skillIds: ['simplifying_expressions'], kind: 'mastery', visual: false, desc: 'three chained values a,b,c (each feeds the next)' },
