...
export const AQA_8300_1F_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    '14b': { skill: 'Estimating', question: 'An estimate of 3.12 × 4.87 + 2.09² is made by rounding each number to 1 significant figure, giving 19. Is 19 an overestimate or an underestimate of the true value? Tick one box, and give a reason for your answer.', answer: 'Underestimate', working: 'Both parts come out smaller than the exact values: 15 is below 3.12 × 4.87, and 4 is below 2.09².' },
    ...
    '16b': { skill: 'Inverse Proportion', question: 'The number of days d to complete a job and the number of workers w are related by d = 600 ÷ w, and completing the job in 25 days needs 24 workers. In fact, the job needs completing in fewer than 25 days. What does this mean about the number of workers needed? Tick one box: fewer than 24 / exactly 24 / more than 24.', answer: 'More than 24 workers', working: 'Days × workers is fixed, so fewer days needs more workers.' },
