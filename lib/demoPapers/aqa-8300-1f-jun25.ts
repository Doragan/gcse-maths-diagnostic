...
export const AQA_8300_1F_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    // 7(a) and (b) share their setup, as on the paper, and (b)'s options are
    // phrased against the permanent offer rather than a number of weeks — so
    // (b) never hands over the answer to (a).
    '7a': { skill: 'Simple Arithmetic', question: 'Trainers cost £40 a pair.\nThere is an offer: buy one pair and get a second pair for half price.\nBea wants to buy two pairs and saves £14 every week.\nAssume the offer is permanent.\nHow many weeks does Bea need to save for?\nYou must show your working.', answer: '5 weeks', working: 'Two pairs cost £40 + £20 = £60, and 4 weeks gives only £56.' },
    '7b': { skill: 'Simple Arithmetic', question: 'Trainers cost £40 a pair.\nThere is an offer: buy one pair and get a second pair for half price.\nBea wants to buy two pairs and saves £14 every week.\nIn fact, the offer is only for one week and there are no new offers.\nWhat does this mean about the number of weeks Bea needs to save for?\nTick one box.\n[   ] Fewer than if the offer were permanent\n[   ] The same as if the offer were permanent\n[   ] More than if the offer were permanent\n[   ] It is not possible to tell', answer: 'More than if the offer were permanent', working: 'She cannot save £60 within the one week, so she pays full price, £80, which takes longer to save.' },
    ...
    // 14(a) and (b) share the calculation; (b) asks about "the estimate"
    // without stating it, so it cannot give away (a).
    '14a': { skill: 'Estimating', question: 'Each number in 3.4 × 5.2 + 2.3² is rounded to 1 significant figure to estimate its value.\nWork out the estimate.\nYou must show your working.', answer: '19', working: '3 × 5 = 15 and 2² = 4.' },
    '14b': { skill: 'Estimating', question: 'Each number in 3.4 × 5.2 + 2.3² is rounded to 1 significant figure to estimate its value.\nIs the estimate an overestimate or an underestimate?\nTick one box.\n[   ] Overestimate\n[   ] Underestimate\nGive a reason for your answer.', answer: 'Underestimate', working: 'Every number was rounded down, so the estimate must be below the true value.' },
    ...
    // The paper shows the formula as a fraction with bullets saying what each
    // letter stands for; (b)'s options are phrased against 25 days, not a
    // number of workers, so (b) does not give away (a).
    '16a': { skill: 'Rearranging Formulae (Changing the Subject)', question: 'd = <frac>600/w</frac>\n• d represents the number of days to complete a job\n• w represents the number of workers needed\nAssume the job needs completing in 25 days.\nHow many workers are needed?', answer: '24 workers', working: '25 = 600 ÷ w, so w = 600 ÷ 25.' },
    '16b': { skill: 'Inverse Proportion', question: 'd = <frac>600/w</frac>\n• d represents the number of days to complete a job\n• w represents the number of workers needed\nIn fact, the job needs completing in fewer than 25 days.\nWhat does this mean about the number of workers that are needed?\nTick one box.\n[   ] It is less than the number needed for 25 days\n[   ] It is the same as the number needed for 25 days\n[   ] It is greater than the number needed for 25 days', answer: 'It is greater than the number needed for 25 days', working: 'Days × workers is fixed at 600, so fewer days needs more workers.' },
