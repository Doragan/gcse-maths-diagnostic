...
export const AQA_8300_1F_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    '7b': { skill: 'Simple Arithmetic', question: 'In fact the offer ends before Bea has saved enough, so she must pay full price for both pairs. What does this mean about the number of weeks she needs to save for? Tick one box: it is less than the answer to part (a) / the same as the answer to part (a) / greater than the answer to part (a) / it is not possible to tell.', answer: 'Greater than the answer to part (a)', working: 'Two pairs at full price is £80, which takes longer to save.' },
    ...
    '14b': { skill: 'Estimating', question: 'Is your answer to part (a) an overestimate or an underestimate? Tick one box, and give a reason for your answer.', answer: 'Underestimate', working: 'Both parts come out smaller than the exact values: 15 is below 3.12 × 4.87, and 4 is below 2.09².' },
    ...
    '16b': { skill: 'Inverse Proportion', question: 'In fact, the job needs completing in fewer than 25 days. What does this mean about the number of workers that are needed? Tick one box: it is less than the answer to part (a) / the same as the answer to part (a) / greater than the answer to part (a).', answer: 'Greater than the answer to part (a)', working: 'Days × workers is fixed, so fewer days needs more workers.' },
    '17': { skill: 'Parts of a Circle', question: 'A chord is drawn on a circle. Which statement is correct? Tick one box: the chord must be shorter than the diameter / the chord must be equal in length to the diameter / the chord must be longer than the diameter / the chord is never longer than the diameter.', answer: 'The chord is never longer than the diameter', working: 'The longest chord a circle has is a diameter, so equal is possible but longer is not.' },
    ...
    '24': { skill: 'Reciprocals', question: 'y = 1 ÷ x. Which of these values of x gives the greatest value of y? Circle your answer: 12, 1/4, 50, −6, 30', answer: '1/4', working: 'The smallest positive x gives the largest 1 ÷ x, and a negative x makes y negative.' },
    '25': { skill: 'Exact Trigonometric Values', question: 'Circle the value of sin 30 degrees: 0, 1/2, 1/sqrt2, sqrt3/2, 1', answer: '1/2' },
