...
export const AQA_8300_3H_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    '13c': { skill: 'Cumulative Frequency', question: 'Using the cumulative frequencies above, estimate the number of employees with a salary less than £25 000', answer: 'About 63', working: 'Halfway between 55 at £20 000 and 70 at £30 000.' },
