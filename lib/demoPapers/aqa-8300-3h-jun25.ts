...
export const AQA_8300_3H_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    '6a': { skill: 'Proportion', question: 'A scale diagram uses a scale of 1 : 250 000.\nOn the diagram, the distance from B to C is 6 cm.\nWork out the actual distance from B to C, in kilometres.', answer: '15 km', working: '6 × 250 000 = 1 500 000 cm, and there are 100 000 cm in a kilometre.' },
