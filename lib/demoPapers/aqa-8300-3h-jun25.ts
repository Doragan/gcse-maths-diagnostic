...
export const AQA_8300_3H_JUN25: PaperConfig = {
  ...
  retrySet: {
    ...
    '9': { skill: 'Ratio + Fractions of Amounts', question: 'Dan has £180. Dan\'s amount is 3/4 of Eve\'s amount, and Finn\'s amount : Eve\'s amount = 2 : 5. Work out how much money Finn has.', answer: '£96', working: 'Eve has £240, and Finn has two fifths of that.' },
    ...
    '21': { skill: 'Volume of a Sphere + Volume of a prism', question: 'Four identical spheres just fit inside a cylinder, and each sphere has radius r. What fraction of the space inside the cylinder is NOT filled by the spheres? You must show your working. The volume of a sphere is (4/3) × pi × r³.', answer: '1/3', working: 'The cylinder is 8r tall, so its volume is 8 pi r³, and the spheres take (16/3) pi r³ — two thirds of it.' },
    '22': { skill: 'Quadratic Inequalities + Solving Quadratic Equations (Factorising)', question: 'Solve 3x² > 10 − x', answer: 'x < −2 or x > 5/3', working: '3x² + x − 10 > 0 factorises to (3x − 5)(x + 2) > 0.' },
    ...
    '24': { skill: 'Area and Volume Scale Factors + Area of a Triangle (½ab sinC)', question: 'Triangles ABC and DEF are similar. AB = 6 cm and the corresponding side DE = 15 cm. The area of triangle ABC is 26.4 cm². Work out the area of triangle DEF.', answer: '165 cm²', working: 'The length scale factor is 2.5, so the area scale factor is 2.5² = 6.25.' },
  },
  challengeQuestions: [],
  sampleStudents: [],
  sampleMarks: {},
