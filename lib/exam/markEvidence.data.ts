...
// Source: data/exam-audit/ (42 papers, 1095 parts,
...
export const BY_SKILL_KIND: Record<string, MarkStats> = {
 ...
 "area_and_volume_scale_factors|exam": {
  "n": 3,
  "mean": 4.33,
  "min": 4,
  "max": 5,
 ...
 "area_and_volume_scale_factors|mastery": {
  "n": 2,
  "mean": 2,
  "min": 2,
  "max": 2,
 ...
 "equations_and_identities|mastery": {
  "n": 5,
  "mean": 2.4,
  "min": 1,
  "max": 3,
  "splits": [
   "B2 (B1 one value correct)",
   "B1 (tick: true for all x)"
  ]
 },
 "estimating|exam": {
  "n": 2,
 ...
 "properties_of_2d_shapes|mastery": {
  "n": 2,
  "mean": 1,
  "min": 1,
  "max": 1,
