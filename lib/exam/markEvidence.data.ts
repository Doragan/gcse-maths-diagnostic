...
// Source: data/exam-audit/ (18 papers, 661 parts,
// 1440 marks). Re-run the script after coding
// a new paper series.
...
export const BY_SKILL_KIND: Record<string, MarkStats> = {
 ...
 "angles_in_polygons|mastery": {
  ...
  "max": 3,
  "splits": [
   "B3 (B2 interior angle found, B1 exterior angle or angle sum)"
  ]
 },
 ...
 "factorising_quadratics|mastery": {
  ...
  "splits": [
   "B2 (B1 partial)",
   "B2 (B1 one correct bracket in a product)"
  ]
 },
 "factorising|mastery": {
  "n": 3,
 ...
 "fractional_and_negative_indices|mastery": {
  ...
  "splits": [
   "B1",
   "B3 (B2 two of the three index ideas shown, B1 one)"
  ]
 },
 ...
 "simplifying_ratio|mastery": {
  ...
  "splits": [
   "M1 A1 A1ft",
   "B2 (B1 unsimplified or with the variable left in)"
  ]
 },
 ...
 "surds_simplifying|mastery": {
  ...
  "splits": [
   "B1",
   "M2 A1 (M1 one or two correct values)"
  ]
 },
